...
export default function PhoneImput({ type, label, name, id, placeholder, ...props }: InputProps){
    ...
    return(
       ...
       <label
        htmlFor={id}
        className="block ml-2 mt-6  text-sm font-medium  text-gray-300"
      >
        {label}
      </label>
    ...
    <div className="flex items-center mt-2 ">
        <button id="dropdown-phone-button" data-dropdown-toggle="dropdown-phone" className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center border-b-2 border-gray-300 focus:border-b-2 focus:border-padel-green text-gray-900" type="button">
        ...
        name={name}
        id={id}
        className="border-b-2 border-gray-300 focus:border-b-2 focus:border-padel-green text-gray-900 text-sm block w-full p-2.5 focus:outline-none focus:transition focus:duration-300 focus:ease-in-out"
